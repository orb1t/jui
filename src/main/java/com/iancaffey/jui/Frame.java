 ...
 * @since 1.0
 */
public class Frame extends Component implements Focusable {
    public Frame() {
        this((String) null);
    }
    ...
    public Frame(Text text) {
        ...
        header.setText(text);
        Button x = new Button(new Text("x"));
        x.setBackground(null);
        x.setBorder(null);
        x.clearOverlay();
        x.setPadding(new com.iancaffey.jui.Insets(2, 0, 2, 2));
    ...
    public Frame(Header header, Component content) {
        setHeader(header);
        setContent(content);
    }
