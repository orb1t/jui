...
import com.iancaffey.jui.event.*;
...
public class Component extends View {
    ...
    public com.iancaffey.jui.Insets getPadding() {
        int left = 0;
        int top = 0;
        int right = 0;
        int bottom = 0;
        com.iancaffey.jui.Insets insets = getController().<com.iancaffey.jui.Insets>get(LookAndFeel.COMPONENT_INSETS, getBackupModel());
        if (insets != null) {
            left = insets.left;
            top = insets.top;
            right = insets.right;
        ...
        if (border != null) {
            com.iancaffey.jui.Insets borderInsets = border.getPadding(this);
        ...
        return new com.iancaffey.jui.Insets(left, top, right, bottom);
    }

    public void setPadding(com.iancaffey.jui.Insets insets) {
    ...
    public void dispose() {
        ...
        } else if (parent instanceof com.iancaffey.jui.Container) {
            ((com.iancaffey.jui.Container) parent).remove(this);
    ...
    public com.iancaffey.jui.Cursor getCursor() {
        return getController().<com.iancaffey.jui.Cursor>get(LookAndFeel.COMPONENT_CURSOR, getBackupModel());
    }

    public void setCursor(com.iancaffey.jui.Cursor cursor) {
        getController().put(LookAndFeel.COMPONENT_CURSOR, cursor);
    }

    public com.iancaffey.jui.Cursor getDisabledCursor() {
        return getController().<com.iancaffey.jui.Cursor>get(LookAndFeel.COMPONENT_CURSOR_DISABLED, getBackupModel());
    }

    public void setDisabledCursor(com.iancaffey.jui.Cursor cursor) {
        getController().put(LookAndFeel.COMPONENT_CURSOR_DISABLED, cursor);
    }

    public com.iancaffey.jui.Cursor getRolloverCursor() {
        return getController().<com.iancaffey.jui.Cursor>get(LookAndFeel.COMPONENT_CURSOR_ROLLOVER, getBackupModel());
    }

    public void setRolloverCursor(com.iancaffey.jui.Cursor cursor) {
        getController().put(LookAndFeel.COMPONENT_CURSOR_ROLLOVER, cursor);
    }

    public com.iancaffey.jui.Cursor getPressedCursor() {
        return getController().<com.iancaffey.jui.Cursor>get(LookAndFeel.COMPONENT_CURSOR_PRESSED, getBackupModel());
    }

    public void setPressedCursor(com.iancaffey.jui.Cursor cursor) {
    ...
    public com.iancaffey.jui.LayoutManager getLayout() {
        return getController().<com.iancaffey.jui.LayoutManager>get(LookAndFeel.COMPONENT_LAYOUT_MANAGER, getBackupModel());
    }

    public void setLayout(com.iancaffey.jui.LayoutManager manager) {
    ...
    public boolean layout(boolean forceRepaint) {
        com.iancaffey.jui.LayoutManager manager = getLayout();
