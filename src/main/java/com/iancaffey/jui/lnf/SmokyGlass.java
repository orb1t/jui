...
public class SmokyGlass extends LookAndFeel {
    public SmokyGlass(Color color) {
        ...
        get(com.iancaffey.jui.Component.class, ComponentModel.class).put(LookAndFeel.COMPONENT_BACKGROUND, new Background(translucentBackground));
        FrameModel frameModel = get(com.iancaffey.jui.Frame.class, FrameModel.class);
        ...
        foverlays.add(new Overlay() {
            ...
            @Override
            public void render(com.iancaffey.jui.Component component, Graphics graphics, int x, int y, int width, int height) {
                int dx = 0;
                int dy = 0;
                int dw = component.getWidth();
                int dh = component.getHeight();
                com.iancaffey.jui.Insets insets = component.getPadding();
                if (insets != null) {
                    dx += insets.left;
                    dy += insets.top;
        ...
        ButtonModel bm = get(com.iancaffey.jui.Button.class, ButtonModel.class);
        ...
        boverlays.add(new Overlay() {
            ...
            @Override
            public void render(com.iancaffey.jui.Component component, Graphics graphics, int x, int y, int width, int height) {
                if (!(component instanceof com.iancaffey.jui.Button))
                    return;
                com.iancaffey.jui.Button button = (com.iancaffey.jui.Button) component;
