...
public class UIManager {
    ...
    public static void paint(Graphics graphics) {
        ...
        if (focus == null || !focus.isVisible())
            focus = pane;
        Cursor cursor = focus.isDisabled() ? focus.getDisabledCursor() : focus.isPressed() ? focus.getPressedCursor() : focus.isHovered() ? focus.getRolloverCursor() : focus.getCursor();
        if (cursor == null)
