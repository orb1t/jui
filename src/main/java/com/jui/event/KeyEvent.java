...
public class KeyEvent extends ComponentEvent {
    ...
    public KeyEvent(Component component, int id, char keyChar, int keyCode, int modifiers, int keyLocation) {
        super(component, id);
    ...
    public String paramString() {
        return super.paramString() + ", char=" + keyChar + ", code=" + keyCode + ", modifiers=" + modifiers + ", location=" + keyLocation;
    }
}
