...
public class LookAndFeel extends Model {
    ...
    public LookAndFeel() {
        ...
        put(com.jui.Container.class, new ContainerModel());
        put(com.jui.Label.class, new LabelModel());
        put(Picture.class, new PictureModel());
        put(ProgressBar.class, new ProgressBarModel());
        put(Text.class, new TextModel());
        put(com.jui.Button.class, new ButtonModel());
        put(Header.class, new HeaderModel());
        put(com.jui.Frame.class, new FrameModel());
    ...
    protected class BasicModel extends Model {
        public BasicModel() {
            ...
            try {
                com.jui.Cursor cursor = new ImageCursor(ImageIO.read(new URL("http://i.imgur.com/aa56XUc.png")), -2, -3);
    ...
    protected class ButtonModel extends BasicModel {
        public ButtonModel() {
            ...
            put(LookAndFeel.COMPONENT_INSETS, new com.jui.Insets(5, 5, 5, 5));
            put(LookAndFeel.BUTTON_TEXT_GAP, 5);
            try {
                com.jui.Cursor hovered = new ImageCursor(ImageIO.read(new URL("http://i.imgur.com/OcL5kp8.png")), -5, 0);
                com.jui.Cursor pressed = new ImageCursor(ImageIO.read(new URL("http://i.imgur.com/IDpIUy2.png")), -5, 0);
    ...
    protected class HeaderModel extends BasicModel {
        public HeaderModel() {
            ...
            put(LookAndFeel.COMPONENT_INSETS, new com.jui.Insets(2, 2, 2, 2));
        }
    }
